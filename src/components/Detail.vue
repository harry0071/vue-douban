<template>
  <mu-container style="padding:70px 10px 10px;">
    <mu-circular-progress :size="46" color="success" style="margin: 0 auto;display: block;" v-if="list == null"></mu-circular-progress>
          ...
          <mu-list-item avatar :ripple="false" button>
            ...
            <mu-list-item-content>
              ...
              <mu-list-item-sub-title>
                <span style="color: #e09015;">{{comment.rating.value | star}}</span>
                <br> {{comment.content}}
              </mu-list-item-sub-title>
            </mu-list-item-content>
          </mu-list-item>
